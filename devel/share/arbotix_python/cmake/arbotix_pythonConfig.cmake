...
if("TRUE" STREQUAL "TRUE")
  set(arbotix_python_SOURCE_PREFIX /home/gao/mysimulation/src/arbotix_ros/arbotix_python)
  set(arbotix_python_DEVEL_PREFIX /home/gao/mysimulation/devel)
  ...
  set(arbotix_python_INSTALL_PREFIX /home/gao/mysimulation/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'arbotix_python' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/gao/mysimulation/src/arbotix_ros/arbotix_python/${idir}'.  ${_report}")
    endif()
