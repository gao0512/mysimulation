...
echo_and_run cd "/home/gao/mysimulation/src/arbotix_ros/arbotix_sensors"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/gao/mysimulation/src/arbotix_ros/arbotix_sensors/setup.py" \
     \
    build --build-base "/home/gao/mysimulation/build/arbotix_ros/arbotix_sensors" \
    install \
    --root="${DESTDIR-/}" \
